...
if __name__ == "__main__":
    ...
    parser.add_argument('--source', type=str, default='gaze360', help="source dataset, gaze360 or eth-mv-train")
    parser.add_argument('--target', type=str, default='eth-mv', help="target dataset, only supporting eth-mv")
